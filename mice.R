...
option_list = list(
  make_option(c("-c", "--path"), action="store", default='D:\\PycharmProjects\\补充实验\\jieguo.csv', 
              type='character', help="back_table"),
  make_option(c("-s", "--score_path"), action="store", default='D:\\PycharmProjects\\补充实验\\jieguo1.csv', 
              type='character', help="back_table")
)
